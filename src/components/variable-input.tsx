  ...
  return (
    <div className="w-full relative">
      <div
        ...
        className="flex h-9 w-full items-center rounded-md border border-muted bg-transparent px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-500 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-700 dark:placeholder:text-neutral-400 focus-visible:border-neutral-800 dark:focus-visible:border-neutral-400"
