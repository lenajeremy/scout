  ...
  var moduleExports = (() => {
    ...
    var En = (e, t) => () => (
      ...
      _e = (e, t, i) => (
        ...
        te(
          t || !e || !e.__esModule
            ? ie(i, "default", { value: e, enumerable: !0 })
            : i,
          e
        )
      ),
      ...
      function i(r) {
        ...
        return (
          ...
          (s.undefined(n.additionalTextEdits) ||
            s.typedArray(n.additionalTextEdits, A.is))
        );
      }
      e.is = i;
    })(We || (We = {}));
    ...
    (function (e) {
      ...
      function r(a, o) {
        for (
          ...
          if (g <= h)
            u = u.substring(0, b) + f.newText + u.substring(g, u.length);
              ...
              h = o.items.map((p) => {
                ...
                return (
                  ...
                  p.additionalTextEdits &&
                    (f.additionalTextEdits = p.additionalTextEdits.map(j)),
    ...
    var ke = class {
      ...
      provideDocumentHighlights(t, i, r) {
        ...
        return this._worker(n)
          ...
          .then((a) => {
            if (!!a)
              return a.map((o) => ({ range: C(o.range), kind: Un(o.kind) }));
          });
      }
    };
    function Un(e) {
        ...
        provideLinks(t, i) {
          ...
          return this._worker(r)
            ...
            .then((n) => {
              if (!!n)
                return {
                  links: n.map((a) => ({ range: C(a.range), url: a.target })),
                };
            });
        }
      },
    ...
    var Z = class {
        ...
        provideDocumentColors(t, i) {
          ...
          return this._worker(r)
            ...
            .then((n) => {
              if (!!n)
                return n.map((a) => ({ color: a.color, range: C(a.range) }));
            });
        }
        provideColorPresentations(t, i, r) {
          ...
          return this._worker(n)
            .then((a) =>
              a.getColorPresentations(n.toString(), i.color, we(i.range))
            )
            .then((a) => {
              if (!!a)
                return a.map((o) => {
                  ...
                  return (
                    ...
                    o.additionalTextEdits &&
                      (u.additionalTextEdits = o.additionalTextEdits.map(j)),
                    u
                  );
                });
            });
...
`;
              ...
              case 117:
                var y = b(4, !0);
                y >= 0 ? (d += String.fromCharCode(y)) : (f = 4);
                break;
              default:
                f = 5;
            }
...
`)),
        ...
        switch (d) {
          ...
          case 57:
            return (n += E()), (o = 11);
          default:
            for (; r < i && kn(d); ) r++, (d = e.charCodeAt(r));
            if (a !== r) {
    ...
    function hn(e) {
      return {
        getInitialState: () => new W(null, null, !1, null),
      ...
      function a() {
        ...
        vn(i),
          c.documentFormattingEdits &&
            i.push(
              l.languages.registerDocumentFormattingEditProvider(u, new G(n))
            ),
          ...
          c.documentSymbols &&
            i.push(l.languages.registerDocumentSymbolProvider(u, new $(n))),
          c.tokens && i.push(l.languages.setTokensProvider(u, hn(!0))),
          c.colors && i.push(l.languages.registerColorProvider(u, new Z(n))),
          c.foldingRanges &&
            i.push(l.languages.registerFoldingRangeProvider(u, new ee(n))),
          c.diagnostics && i.push(new xe(u, n, e)),
          c.selectionRanges &&
            i.push(l.languages.registerSelectionRangeProvider(u, new ne(n)));
      }
